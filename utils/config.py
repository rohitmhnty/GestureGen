...
def parse_args(config_path=None):
    ...
    parser.add("--nb_code", default=1024, type=int)
    parser.add("--code_dim", default=128, type=int)
    parser.add("--down_t", default=2, type=int)
    parser.add("--stride_t", default=2, type=int)
    parser.add("--down_s", default=2, type=int)
...
#    parser.add("--gan_noise_size", default=0, type=int)
    ...
    # --------------- vqvae -------------------------- #
    parser.add("--num_quantizers", default=6, type=int)
    parser.add("--shared_codebook", default=False, type=str2bool)
    parser.add("--quantize_dropout_prob", default=0.2, type=float)
    parser.add("--mu", default=0.99, type=float)
    ...
    parser.add("--vq_act", default='relu', type=str)
    parser.add("--vq_norm", default=False, type=str2bool)
